import { LOADING_CONTENT_MAIN_ID, LOADING_CONTENT_SECONDARY_ID, LOADING_SCREEN_MAIN_ID, LOADING_SCREEN_SECONDARY_ID, LOADING_TIP_TEXT_ID } from "../../config/config-manager.js";
import { animationLoop } from "../../rendering/canvas-manager.js";

// ==============================
// Main Loading Screen Handling
// ==============================
export const setupMainLoadingScreen = function (wallpaper, drawMapCallback) {
    ...
    if (imageLoaded && minimumDelayPassed) {
      ...
      const fadeInterval = setInterval(() => {
        ...
        if (opacity <= 0) {
          ...
          window.dispatchEvent(new CustomEvent("application-started"));
...
export const loadWithScreen = async function (task) {
  let timeoutId;
...
export const loadImageWithCache = async function (newSrc, existingImage) {
